...
<div id="mainContent">
	...
	<script type="text/javascript">
		var organizations = ["'.implode('", "', $this->organization_names).'"];
	...
	<h1 style="text-align:left;">Submit Relief Information</h1>
	<p>Please submit information below.</p>
	<form method="post" action="'.$_SERVER['PHP_SELF'].'" class="relief-submission-form">
		<table border=0 cellpadding=3>
			...
			<tr valign=top>
				<td>&nbsp;</td>
				<td>
					<input type="hidden" name="submitted" value="true"><input type="submit" value="Save" class="btn btn-large btn-success">
				</td>
			</tr>
		</table>
	</form>
